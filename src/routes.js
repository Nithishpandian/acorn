...
const pages = {
  ...
  authentication: {
    ...
    rolespage: lazy(()=> import('views/pages/authentication/RolesPage')),
    userpage: lazy(()=> import('views/pages/authentication/UserPage')),
  },
  blog: {
      ...
      subs: [
        {
          ...
          subs: [
            ...
            { path: '/role', label: 'Roles', component: pages.authentication.rolespage, noLayout: true },
            { path: '/user', label: 'User', component: pages.authentication.userpage, noLayout: true },
          ],
        },
        {
          path: '/blog',
